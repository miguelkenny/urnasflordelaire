export default [
  ...
  },
  {
    ...
    descripcionLarga: [
      ...
      "Ideal para contener la memoria de personas de espíritu generoso y amor expansivo."
    ],
    imagenes: [
  ...
  {
    slug: "urna-simil-piedra",
    nombre: "Urna Simil Piedra",
  ...
  {
    slug: "urna-1750-pluma",
    nombre: "Urna Pluma 1.750",
    descripcion: "Una urna azul serena con una pluma plateada, símbolo de liviandad, trascendencia y paz.",
    descripcionLarga: [
      "Como una caricia del viento, esta urna azul transmite serenidad y profundidad espiritual.",
      "La pluma plateada grabada en su superficie representa la ligereza del alma en su viaje, el desprendimiento suave y la conexión con lo sutil.",
      "Inspirada en la idea de que el alma no pesa, sino que flota hacia lo eterno, esta urna es ideal para quienes vivieron con sensibilidad, sabiduría y una presencia que aún se percibe, aunque ya no se vea.",
  ...
  {
    slug: "urna-2500-pluma",
    nombre: "Urna Pluma 2.500",
    descripcion: "Una urna azul serena con una pluma plateada, símbolo de liviandad, trascendencia y paz.",
    descripcionLarga: [
      "Como una caricia del viento, esta urna azul transmite serenidad y profundidad espiritual.",
      "La pluma plateada grabada en su superficie representa la ligereza del alma en su viaje, el desprendimiento suave y la conexión con lo sutil.",
  ...
  },
  {
    slug: "urna-otono",
    nombre: "Urna Otoño",
    descripcion: "Una urna color caramelo con hojas bronce, símbolo del ciclo natural, la belleza del cambio y la calidez del recuerdo.",
    descripcionLarga: [
      "La urna Otoño celebra la sabiduría del tiempo y el valor de cada etapa vivida.",
      "Su tono caramelo evoca la tierra cálida, el hogar y el abrazo del pasado.",
      "Las hojas bronce, cuidadosamente dispuestas, representan la transformación, el soltar con gratitud y el legado que permanece.",
      "Como los árboles que dejan ir sus hojas para renovarse, esta urna honra a quienes supieron cerrar ciclos con plenitud, dejando huellas nobles y profundas.",
  ...
  },
  {
    ...
    descripcionLarga: [
      "La urna Origen fue pensada como un homenaje al inicio de todo.",
      "Con una capacidad generosa de 3.5 litros, es ideal para contener historias profundas y memorias compartidas.",
      "Disponible en celeste pastel, que simboliza la calma, la apertura emocional y la pureza del cielo; y en rosa pastel, color que representa el amor incondicional, la ternura y la conexión con lo esencial.",
      "Su diseño limpio y envolvente invita a abrazar el ciclo de la vida con suavidad y respeto.",
      "Es una urna que guarda no solo cenizas, sino también el sentido del regreso: a uno mismo, a la tierra, al amor."
    ],
    imagenes: [
  ...
  },
  {
    ...
    descripcionLarga: [
      "La urna Gota de Rocío es una pieza única que combina arte, simbolismo y serenidad.",
      ...
      "Con su diseño refinado y espíritu poético, Gota de Rocío es una urna que honra la delicadeza del alma y su paso silencioso por el mundo."
    ],
    imagenes: [
      "/images/gota.png",
    ],
  ...
  },
  {
    ...
    descripcionLarga: [
      "La Urna para Angelitos es una pieza escultórica pensada con profundo amor y respeto.",
