<script>
  ...
  const datos = [
    ...
    },
    {
      ...
      gramos: "1.350 g",
      peso: "45–55 kg",
      uso: "Personas delgadas o niños mayores",
      tipo: "persona",
    },
    {
      litros: "1.500",
      gramos: "1.500 g",
      peso: "50–60 kg",
      uso: "Adultos de contextura delgada",
      tipo: "persona",
    },
    {
      litros: "1.750",
    ...
    },
    {
      ...
      gramos: "2.500 g",
      peso: "85–100 kg",
      uso: "Personas grandes o reserva de cenizas",
      tipo: "persona",
    },
    {
      litros: "3.000",
      gramos: "3.000 g",
      peso: "100–115 kg",
      uso: "Personas grandes o mezcla familiar",
      tipo: "persona",
    },
    {
      litros: "3.500",
      gramos: "3.500 g",
      peso: "Hasta 130 kg o más",
      uso: "Cenizas múltiples / gran volumen",
      tipo: "persona",
    },
  ];
